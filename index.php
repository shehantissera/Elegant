...
<html lang="en"><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <body class="clearfix" data-smooth-scrolling="1">
        <div class="vc_body">
            ...
            <div class="vc_banner vc_bg-none simple_slide block">
                <div class="wrapper">
                    <div class="banner">
                        <div id="carousel">
                            <div><img alt="example image" src="img/slide-img/01.jpg" /></div>
                            <div><img alt="example image" src="img/slide-img/02.jpg" /></div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span7">
                                <div class="description">
                                    <p class="subtitle"> <span class="vc_inverted"> We simply </span>the best ... </p>
                                    <p class="text"> So are you excited about <strong> Vencorp Theme </strong> as much as we do? Let's get started by browsing on our home page through contact page. Look every detail, we make it as simple  as it can be yet, beautiful. </p>
                                </div>
                            </div>
                            <div class="span3">
                    ...
                    <div class="container">
                        ...
                        <div class="row-fluid">
                            <div class="span4">
                                <div class="vc_icon-round">
                                    <div class="bg-wrapper">
                                        <div class="bg"> <i class="icon-random"> </i> </div>
                                    </div>
                                </div>
                                <h4> Premium Plugin </h4>
                                <p> Metro Slider, Revolution Slider, Caroufred Slider, Isotope. All worth more than $40, no need to buy anymore.</p>
                            </div>
                            <div class="span4">
                                <div class="vc_icon-round">
                                    <div class="bg-wrapper">
                                        <div class="bg"> <i class="icon-fullscreen"> </i> </div>
                                    </div>
                                </div>
                                <h4> Fully Responsive </h4>
                                <p> Vencorp Theme adapt in all type of device:
                                    handheld, smartphone, tablets, laptops </p>
                            </div>
                            <div class="span4">
                                <div class="vc_icon-round">
                                    <div class="bg-wrapper">
                                ...
                                <h4> 30+ Pages </h4>
                                <p> More than 30 responsive HTML pages available, create all code combination you want.</p>
                            </div>
                        </div>
                        <!-- row-fluid --> 
                    </div>
            ...
            <div class="vc_latest-portfolio block">
                <div class="wrapper">
                    <div class="container">
                        <h2 class="pull-left"> Latest <span class="vc_main-color"> Portfolio </span> </h2>
                        ...
                        <div class="vc_carousel-wrap">
                            <div class="vc_carousel clearfix">
                                        ...
                                        <div class="vc_hover">
                                            <div class="hover-wrapper">
                                                ...
                                                <div class="icon-wrapper">
                                                    <ul>
                                                        <li class="vc_icon"> <a data-rel="prettyPhoto[portfolio]" href="img/portfolio/01.jpg"> <i class="icon-zoom-in"> </i> </a> </li>
                                    ...
                                    <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.html" class="vc_preview"> <img alt="example image" src="img/portfolio/02.jpg" /> </a>
                                        <div class="vc_hover">
                                            <div class="hover-wrapper">
                                                ...
                                                <div class="icon-wrapper">
                                                    <ul>
                                                        <li class="vc_icon"> <a data-rel="prettyPhoto[portfolio]" href="img/portfolio/02.jpg"> <i class="icon-zoom-in"> </i> </a> </li>
                                                        <li class="vc_icon"> <a href="portfolio-single-project.html"> <i class="icon-link"> </i> </a> </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.html" class="vc_preview"> <img alt="example image" src="img/portfolio/03.jpg" /> </a>
                                        <div class="vc_hover">
                                            <div class="hover-wrapper">
                                                ...
                                                <div class="icon-wrapper">
                                                    <ul>
                                                        <li class="vc_icon"> <a data-rel="prettyPhoto[portfolio]" href="img/portfolio/03.jpg"> <i class="icon-zoom-in"> </i> </a> </li>
                                                        <li class="vc_icon"> <a href="portfolio-single-project.html"> <i class="icon-link"> </i> </a> </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <!-- vc_carousel-column -->
                                <div class="vc_carousel-column">
                                    <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.html" class="vc_preview"> <img alt="example image" src="img/portfolio/04.jpg" /> </a>
                                        <div class="vc_hover">
                                            <div class="hover-wrapper">
                                                <div class="text-wrapper">
                                                    <h4> My Very Very Very Very Very Very Best Portfolio </h4>
                                                </div>
                                                <div class="icon-wrapper">
                                                    <ul>
            ...
            <div class="vc_blog-contact block">
                <div class="wrapper">
                    <div class="container">
                        <div class="row-fluid">
                            <div id="vc_blog-list-widget" class="widget span8">
                                <div class="vc_blog-list">
                                    <h2> Latest <span class="vc_main-color"> Blogs </span> </h2>
                                    <div class="vc_splitter"> <span class="bg"> </span> </div>
                                    <article class="blog-row clearfix">
                                        <div class="blog-left">
                                            <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.html" class="vc_preview"> <img alt="example image" src="img/blog/01.jpg" /> </a>
                                                <div class="vc_hover">
                                                    <div class="hover-wrapper">
                                                        <div class="icon-wrapper">
                                                            <ul>
                                        ...
                                        <div class="blog-right clearfix">
                                            <h3> <a href="blog-single.html"> Starting a new business </a> </h3>
                                            ...
                                            <div class="description">
                                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidtation ullamco laboris nisi ut aliquip ex... <a href="blog-single.html" class="vc_read-more"> read more </a> </p>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="blog-row clearfix">
                                        <div class="blog-left">
                                            <div class="vc_anim vc_anim-slide"> <a href="blog-single.html" class="vc_preview"> <img alt="example image" src="img/blog/02.jpg" /> </a>
                                                <div class="vc_hover">
                                                    <div class="hover-wrapper">
                                                        <div class="icon-wrapper">
                                                            <ul>
                                        ...
                                        <div class="blog-right clearfix">
                                            ...
                                            <span class="date"> 14 February 2013 </span> <span class="comments"> <i class="icon-comments"> </i> 16 </span> <span class="taxonomy"> <i class="icon-tags"> </i> <a href="#"> Design </a>, <a href="#"> Creative </a> </span>
                                            <div class="description">
                                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidtation ullamco... <a href="blog-single.html" class="vc_read-more"> read more </a> </p>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="blog-row">
                                        <div class="blog-left">
                                            <div class="vc_anim vc_anim-slide"> <a href="blog-single.html" class="vc_preview"> <img alt="example image" src="img/blog/03.jpg" /> </a>
                                                <div class="vc_hover">
                                                    <div class="hover-wrapper">
                                                        <div class="icon-wrapper">
                                                            <ul>
                                        ...
                                        <div class="blog-right clearfix">
                                            <h3> <a href="blog-single.html"> Creativity in Positivity </a> </h3>
                                            <span class="date"> 14 February 2013 </span> <span class="comments"> <i class="icon-comments"> </i> 16 </span> <span class="taxonomy"> <i class="icon-tags"> </i> <a href="#"> Design </a>, <a href="#"> Creative </a> </span>
                                            <div class="description">
                                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidtation ullamco laboris nisi ut aliquip ex... <a href="blog-single.html" class="vc_read-more"> read more </a> </p>
                                            </div>
                            ...
                            <!-- #vc_blog-list-widget .span8-->
                            <div id="vc_contact-form-widget" class="widget span4">
                                <div class="vc_contact-form">
                                    ...
                                    <form action="php/quick-contact.php" method="post" id="contact-form" name="contact-form" />
                                    ...
                                    <table>
                                        <tr>
                                            <td class="last"><input type="text" onfocus="if (this.value == 'Name:')
                                                        this.value = '';" onblur="if (this.value == '')
                                                        this.value = 'Name:';" value="Name:" size="35" class="required" id="contact-form-name" name="contact-form-name" /></td>
                                        </tr>
                                        <tr>
                                            <td class="last"><input type="email" onfocus="if (this.value == 'E-mail:')
                                                        this.value = '';" onblur="if (this.value == '')
                                                        this.value = 'E-mail:';" value="E-mail:" size="35" class="required email" id="contact-form-email" name="contact-form-email" /></td>
                                        </tr>
                                        <tr>
                                            <td class="last"><textarea onfocus="if (this.value == 'Message:')
                                                        this.value = '';" onblur="if (this.value == '')
                                                        this.value = 'Message:';" class="required" id="contact-form-message" name="contact-form-message" cols="32" rows="10">Message:</textarea></td>
                                        </tr>
                                        <tr>
                                            <td class="last"><input type="submit" value="Send Message" class="vc_btn" id="contact-form-submit" name="contact-form-submit" />
